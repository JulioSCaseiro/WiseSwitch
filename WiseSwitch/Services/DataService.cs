    ...
    public class DataService
    {
        ...
        public async Task<object> GetDataAsync(string dataOperation, object value)
        {
            return dataOperation switch
            {
                ...
                DataOperations.GetEditModelBrand => await _apiService.GetDataFromApiAsync<EditBrandViewModel>($"api/Brands/EditModel/{(int)value}"),
                ...
                DataOperations.GetEditModelFirmwareVersion => await _apiService.GetDataFromApiAsync<EditFirmwareVersionViewModel>($"api/FirmwareVersions/EditModel/{(int)value}"),
                ...
                DataOperations.GetEditModelManufacturer => await _apiService.GetDataFromApiAsync<EditManufacturerViewModel>($"api/Manufacturers/EditModel/{(int)value}"),
                ...
                DataOperations.GetEditModelProductLine => await _apiService.GetDataFromApiAsync<EditProductLineViewModel>($"api/ProductLines/EditModel/{(int)value}"),
                ...
                DataOperations.GetEditModelProductSeries => await _apiService.GetDataFromApiAsync<EditProductSeriesViewModel>($"api/ProductSeries/EditModel/{(int)value}"),
