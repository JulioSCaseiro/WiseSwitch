...
namespace WiseSwitch.Controllers
{
    ...
    public class SwitchModelsController : AppController
    {
        ...
        protected override async Task GetInputCombos()
        {
            ...
            ViewBag.ComboFirmwareVersions = await _dataService.GetAsync<IEnumerable<SelectListItem>>(ApiUrls.GetFirmwareVersionsCombo, null);
        }
        ...
        {
            return View(await _dataService.GetAsync<IEnumerable<IndexRowSwitchModelViewModel>>(ApiUrls.GetSwitchModelsOrderByModelName, null));
        }
        ...
        public async Task<IActionResult> Create(int productSeriesId)
        {
            ...
            else
            {
                ...
                var dependencyChainIds = await _dataService.GetAsync<ProductSeriesDependencyChainIds>(ApiUrls.GetProductSeriesDependencyChainIds, productSeriesId);
        ...
        public async Task<IActionResult> Create(CreateSwitchModelViewModel model)
        {
            ...
            try
            {
                await _dataService.CreateAsync(ApiUrls.CreateSwitchModel, model);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var model = await _dataService.GetAsync<EditSwitchModelViewModel>(ApiUrls.GetSwitchModelEditModel, id);
        ...
        public async Task<IActionResult> Edit(EditSwitchModelViewModel model)
        {
            ...
            try
            {
                await _dataService.UpdateAsync(ApiUrls.UpdateSwitchModel, model);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var model = await _dataService.GetAsync<DisplaySwitchModelViewModel>(ApiUrls.GetSwitchModelDisplay, id);
            if (model == null) return NotFound(EntityNames.SwitchModel);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            try
            {
                await _dataService.DeleteAsync(ApiUrls.DeleteSwitchModel, id);
